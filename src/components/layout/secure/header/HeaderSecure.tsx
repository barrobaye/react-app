...
<header className=" flex w-full flex-row-reverse bg-gray-50 dark:bg-gray-900  ">
<div className="flex justify-between items-center w-full  mx-auto lg:px-8 w-full">
    {/* <!-- Start coding here --> */}
    <div className=" ">
     ...
     <div className="flex items-center">
                          <img className="rounded-full w-12 h-12" src="../../src/assets/barroprofil.jpeg"/>
                          <div >
                            <strong>Andrew Alfred</strong>
                          </div>
                          <button type="button" className="text-white h-10 bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Déconnexion</button>
           </div>
  </div>
